...
//    $allServiceArray = get_all_cases();
    ...
    $subMenuURL = get_home_url() . "/accountant-files-management/?FType=";
    ...
    <div id="main">
        <div class="formPart">
            <div class="FATitle"><p class="titleSize"><strong>FILES MANAGEMENT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <?php
                        echo '<a class="FASubTitle" href="' . $subMenuURL . "Approved" . '">&nbsp;&nbsp;Approved Files&nbsp;&nbsp;</a>|<a class="FASubTitle" href="' . $subMenuURL . "Final" . '">&nbsp;&nbsp;Final Reports&nbsp;&nbsp;</a>';
                        ?></strong></p>
            </div>
