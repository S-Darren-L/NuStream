                ...
                <div class="ESRASelectPart">
                    <div class="ESRAOneLineDiv">
                        <div class="ESRAHouseSizePart">HOUSE SIZE *<br/>
                            <input type="text" value="<?php echo $houseSize; ?>" name="houseSize" class="ESRAHouseSize" require/>
                        </div>
                        <div style="display:inline-block;margin-left:10px;">PROPERTY TYPE *<br/>
                        ...
                        <div style="display:inline-block;margin-left:10px;"><br/>
